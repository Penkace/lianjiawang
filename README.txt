...
三、分析报告
7. 分析报告保存在"租房信息分析.docx"；
8. 分析报告也保存为pdf文件；

四、其他
9. 数据分析过程中图片保存在image文件夹中；
11. 清晰房屋经纬度之后的热力图为"clear_heatmap.html"，未清洗的热力图为"heatmap.html",未清洗的点图为"point_map.html"，发布日期超过30天的房屋分布图"release_day_more30.html"
12. jupyter notebook保存结点为".ipynb_checkpoints"；
